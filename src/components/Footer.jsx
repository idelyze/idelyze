          ...
          <div style={{
            ...
            <div>
              ...
              <address style={{ fontStyle: "normal", marginBottom: 20 }}>
                <p style={{ fontSize: 12, color: T.muted, marginBottom: 3 }}>
                  📍 India — working globally
                </p>
                <a
                  href="tel:+918960685128"
                  style={{
                    fontSize: 12,
                    color: T.muted,
                    textDecoration: "none",
                ...
                <a
                  href="mailto:idelyze.mail@gmail.com"
                  style={{
                    fontSize: 12,
                    color: T.muted,
                    textDecoration: "none",
        ...
        {isMobile && (
          <div style={{ marginBottom: 36 }}>
            ...
            <div style={{ marginBottom: 32 }}>
              ...
              <address style={{ fontStyle: "normal", marginBottom: 18 }}>
                <p style={{ fontSize: 12, color: T.muted, marginBottom: 3 }}>
                  📍 India — working globally
                </p>
                <a
